...
RUN apk add --no-cache musl-dev nginx php7 php7-opcache php7-mysqli php7-pdo_mysql php7-mbstring php7-json php7-zlib php7-gd php7-session php7-fpm php7-curl php7-xml php7-zip php7-iconv php7-sockets php7-ctype php7-openssl;
